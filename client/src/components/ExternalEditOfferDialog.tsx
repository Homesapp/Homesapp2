...
const offerEditSchema = z.object({
  ...
  edad: z.number().min(18, "Edad mínima 18 años").optional().nullable(),
  ...
  numeroInquilinos: z.number().min(1, "Número de inquilinos requerido").optional().nullable(),
  tieneGarante: z.string().optional(),
  usoInmueble: z.enum(["vivienda", "subarrendamiento"]),
  rentaOfertada: z.number().min(0, "Renta ofertada requerida").optional().nullable(),
  rentasAdelantadas: z.number().min(0).optional().nullable(),
  fechaIngreso: z.string().optional(),
  fechaSalida: z.string().optional(),
  duracionContrato: z.string().optional(),
  contractCost: z.number().optional().nullable(),
